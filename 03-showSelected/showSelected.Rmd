...
* Translate one of the
  ...
  plotting function inside the for loop, use the list-of-data-tables
  idiom to store the data that should be plotted (TODO:ref
  appendix). Then use those data along with `showSelected` aesthetics
