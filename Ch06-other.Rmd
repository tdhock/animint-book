...
of the `chunk_vars` variables. Fewer selection variables specified in
...
TSV file because the filesystem stores a constant amount of metadata
for every file.
...
`geom6_vline_signal`, and the data viz takes up 1084 kilobytes. In
