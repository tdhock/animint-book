...
* the `color_off` and `alpha_off` geom parameters for specifying how
  selection state is displayed;
...
below. Those defaults may be customized by using the `alpha_off` and
`color_off` geom parameters as in the code below,
