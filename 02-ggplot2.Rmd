...
Each ggplot contain exactly one *layer*, a `geom_point` which displays
...
* You want to align the axes of several related plots containing
  different geoms.
* There are too many observations to display informatively in one
  panel.
...
1995). In the next chapter, we will show how the new `showSelected`
keyword can be used to achieve animation, and show more of this data
set.
