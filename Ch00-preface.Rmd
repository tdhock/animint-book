...
# Welcome to the Animint book web site!

This book explains how to create interactive data visualizations using
the R package `animint`. The chapters of this book are organized as
follows.
