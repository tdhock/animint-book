...
this book we will use a classification of data sets into three sizes:
...
As another example, consider the more complicated data visualization
below.

TODO worldwide temperature data viz?
