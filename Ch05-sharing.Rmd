...
others. But since Jan 2023, bl.ocks.org is redirecting to gist, and is
not rendering, so it would be better to use one of the other options,
or try to get gist rendering working using [another
