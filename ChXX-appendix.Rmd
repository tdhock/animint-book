...
```{r setup, echo=FALSE}
knitr::opts_chunk$set(fig.path="ChXX-figures/")
```

This appendix describes several idioms which are useful for creating
animints.

## Summarize data table {#summarize-data-table}

TODO

## Parallel computations with a foreach loop {#foreach-loop}

TODO

## Hide all but the selected object

alpha=0.5

## Select any x axis value
