...
[named clickSelects/showSelected variables](Ch06-other.html#data-driven-selectors) aesthetics for
...
* We then explain the preferred method for defining an animint with
  many selectors, using `.variable` and `.value` aesthetics. This
...
## Define data viz using variable and value aesthetics {#define-using-var-val}
