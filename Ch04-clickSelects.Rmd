...
As of release `2022.6.15`, it is also possible to specify the opacity
for objects which are not currently selected using the `alpha_off` 
parameter. Using this parameter allows different emphasis to be 
placed on selected and un-selected items freely, instead of being
forced to rely on the behavior described above.
