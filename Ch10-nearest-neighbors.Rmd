...
Figure consists of two plots (TODO SKETCH):
...
`doParallel` package. This is an example of the
[foreach loop idiom](ChXX-appendix.html#foreach-loop) which is
generally useful for parallel computations. Note that validation folds
...
[summarize data table idiom](ChXX-appendix.html#summarize-data-table)
